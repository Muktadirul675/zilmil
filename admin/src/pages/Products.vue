      ...
      <div class="flex flex-wrap gap-3 items-center">
        ...
        <div class="flex items-center gap-2">
          ...
          <input
            ...
            type="number"
            min="1"
            v-model.number="productStore.limit"
      ...
      <Transition name="slide-fade">
        <div v-if="showFilters" class="p-4 border-t border-gray-100">
          ...
          <div class="mt-4 flex gap-3">
            <button @click="applyFilters" class="bg-indigo-600 text-white px-4 py-2 rounded hover:bg-indigo-700 flex items-center gap-2">
              <i class="pi pi-filter"></i>
              Apply
            </button>
            <button @click="clearFilters" class="bg-gray-200 text-gray-800 px-4 py-2 rounded hover:bg-gray-300 flex items-center gap-2">
    ...
    <div class="overflow-x-auto bg-white rounded shadow">
      <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          <tr v-for="product in productStore.products" :key="product.id" class="cursor-pointer hover:bg-gray-50"
          ...
          <tr v-if="!productStore.products.length && !productStore.loading">
