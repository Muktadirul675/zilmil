    ...
    <div class="fixed top-5 left-1/2 -translate-x-1/2 z-50 flex flex-col gap-3">
      <TransitionGroup name="toast" tag="div">
        <div v-for="toast in toasts" :key="toast.id"
          :class="`flex mb-2 items-start gap-2 px-4 py-3 rounded-lg shadow border border-gray-300 bg-white min-w-[250px] max-w-md animate-fade-in ${borderClass(toast.type)}`">
