<template>
  <div class="w-full flex justify-center" v-if="slides.length">
    <div class="w-full lg:w-[80%] relative">
      ...
      <!-- Controls -->
      <div
        class="absolute top-1/2 left-0 -translate-y-1/2 z-10 p-1 bg-white/80 hover:bg-white rounded-full cursor-pointer"
        click="scrollLeft"
      >
        <i class="pi pi-angle-left"></i>
      </div>
      <div
        class="absolute top-1/2 right-0 -translate-y-1/2 z-10 p-1 bg-white/80 hover:bg-white rounded-full cursor-pointer"
        click="scrollRight"
      >
