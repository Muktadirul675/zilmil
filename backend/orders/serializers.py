...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = [
            'id', 'z_id', 'session_id', 'full_name', 'phone', 'shipping_address',
        ...
        read_only_fields = ['id','z_id','created_at', 'updated_at', 'session_id', 'total_price','courier_reason','courier', 'c_id', 'courier_status', 'confirmed_by_name', 'confirmed_by_date']
