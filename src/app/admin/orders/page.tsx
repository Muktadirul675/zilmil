...
export default async function Order({ searchParams }: { searchParams: { page: string } }) {
    let pageStr = '1'
    if (searchParams) {
    ...
    return <div>
        ...
        <div className="flex justify-between my-2">
            ...
            </div> : <Link href={`/admin/orders?page=${prev()}`} className="border px-1 5 py-1 rounded cursor-pointer bg-white font-bold flex items-center">
                <BiLeftArrow className="text-lg" /> <div className="mx-1"></div> Previous
            </Link>
            }
            ...
            </div> : <Link href={`/admin/orders?page=${next()}`} className="border px-1 5 py-1 rounded cursor-pointer bg-white font-bold flex items-center">
